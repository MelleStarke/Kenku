...
#SBATCH --job-name="train_drl_teacher_final"
#SBATCH --output="/home3/s4984218/Kenku/habrok/jobscripts/results/train_drl_teacher/final/%j.out"
...
cat ~/Kenku/habrok/jobscripts/train_drl_teacher.sh
...
srun --export=ALL python -m train.train_model --config-dir /home3/s4984218/Kenku/train/configs/train/drl_teacher --run-dir ~/scratch/runs/drl_teacher/final/$SLURM_JOB_ID --n-cores $SLURM_CPUS_PER_TASK
