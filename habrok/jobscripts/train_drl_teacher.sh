...
srun --export=ALL python -m train.train_model --config-dir ./train/configs/best_teacher --run-dir ~/scratch/runs/drl_teacher/sanity_check_$SLURM_JOB_ID --batch-size 600 --epochs 200 --checkpoint-max 5 --drl
